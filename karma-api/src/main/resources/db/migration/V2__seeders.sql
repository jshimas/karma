...
INSERT INTO activities (id, organization_id, name, start_date, end_date, is_public, description, address, geo_location, created_at, updated_at)
VALUES
    ('1f1a7893-03d1-41f0-a810-80ed61ce1d16', 'cbe308ea-23b7-4e7a-b07b-39ebfddbd0b7', 'Annual Charity Gala', '2023-11-15 18:00:00', '2023-11-15 20:00:00', TRUE, 'Join us for a night of fundraising', 'Grand Ballroom', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('7f5a792d-36a4-419e-a2db-e75db37ca7db', 'd4f52d2b-753e-4832-b0e2-96c8c836b51b', 'Community Cleanup', '2023-10-25 09:00:00', '2023-10-25 12:00:00', TRUE, 'Help clean up our neighborhood', 'Community Park', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('4e7e0a8e-7d0a-4b21-9a63-7a2e8fbd6f61', '7eb9a07e-238e-4137-8f7e-7c6d92d012f5', 'Coding Workshop', '2023-09-20 14:30:00', '2023-09-20 15:30:00', TRUE, 'Learn coding with experts', 'Edu Institute Classroom', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('b7f245d2-86f2-4bdf-9d45-81d0eecd7ac3', 'cbe308ea-23b7-4e7a-b07b-39ebfddbd0b7', 'Holiday Toy Drive', '2023-12-10 10:00:00', '2023-12-10 15:15:00', TRUE, 'Collecting toys for underprivileged children', 'Shopping Mall', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('7ab4a2b5-ec5b-45ca-923d-e3a78375ddc6', 'd4f52d2b-753e-4832-b0e2-96c8c836b51b', 'Community Potluck', '2023-10-05 17:30:00', '2023-10-05 17:30:00', TRUE, 'Share food and stories with neighbors', 'Community Center Hall', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert fake data into event_scopes
INSERT INTO activity_scopes (activity_id, scope_id)
VALUES
    ('1f1a7893-03d1-41f0-a810-80ed61ce1d16', 1),
    ('7f5a792d-36a4-419e-a2db-e75db37ca7db', 3),
    ('4e7e0a8e-7d0a-4b21-9a63-7a2e8fbd6f61', 4),
    ('b7f245d2-86f2-4bdf-9d45-81d0eecd7ac3', 5),
    ('7ab4a2b5-ec5b-45ca-923d-e3a78375ddc6', 6);

-- Insert fake data into feedbacks
INSERT INTO feedbacks (id, comment, activity_id, user_id)
VALUES
    ('4ca56d9c-82cc-4e12-b2f4-4eaf7e7f90a6', 'Great activity, I had a wonderful time!', '1f1a7893-03d1-41f0-a810-80ed61ce1d16', 'd49d2e22-2b6b-4d8c-9f8d-9f24495e1662'),
    ...
    ('3d2a1b4c-1234-4a4b-8a8b-7a2b2c3d4e5f', 'The gala activity was a huge success, kudos to the team!', '1f1a7893-03d1-41f0-a810-80ed61ce1d16', 'd49d2e22-2b6b-4d8c-9f8d-9f24495e1662'),
